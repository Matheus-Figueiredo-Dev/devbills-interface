			...
			<div className='container-app'>
				...
				<section className='py-12 md:py-20'>
					<div className='grid grid-cols-1 md:grid-cols-2 gap-12 items-center'>
						<div>
							...
							<p className='text-lg text-white mb-8'>Uma plataforma simples e eficiente para
								controlar suas despesas e receitas.Organize suas finanças pessoais ou do seu negócio
								com facilidade.
							</p>
						</div>
					...
					<div className='container-app'>
						<div className='text-center mb-12'>
							...
							<p className='text-lg text-white max-w-2xl mx-auto'>
								Nossa plataforma oferece tudo o que você precisa para manter suas finaças organizadas.
							</p>
						</div>
				...
				<section className='py-12 md:py-20'>
					<div className='bg-gray-900 p-8 md:p-12 rounded-xl text-center border border-gray-700'>
						<h2 className='text-2xl md:text-2xl font-bold text-white mb-4'>Pronto para organizar suas finanças</h2>
